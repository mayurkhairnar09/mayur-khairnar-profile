      ...
      <div className="container">
        <div className="footer-content">
          <div className="footer-section">
            ...
            <p>
              Full-Stack Software Engineer with 3+ years of experience in React.js, Node.js, and Azure. 
              Currently at Cyncly, building scalable web solutions for 40+ clients. Microsoft Azure Certified.
            </p>
          </div>
